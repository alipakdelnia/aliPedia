...
import com.example.alipedia.activities.MainActivity2
import com.example.alipedia.adapter.TrendAdapter
...
class FragmentTrends : Fragment() , ItemEvent {
...
//ferrari
        ...
        val myAdapter = TrendAdapter(data , this)

        binding.recycleTrend.layoutManager=
